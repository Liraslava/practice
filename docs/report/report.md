...
|4 |  Storage подменяет файл после проверки  | Data output | 2 |
|5 |  Storage подменяет файл после проверки  | Data input | 2 |
|6 |  Storage подменяет файл после проверки  | Verifire | 1 |
|7 |  Storage подменяет файл после проверки  | Manager | 1 |
