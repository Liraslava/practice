...
![Негативный сценарий4](./diagrams/docs/report/sd-negative/Negative 4.png?raw=true "Data output имеет возможность отправить данные на устройство")
...
|4 |  Storage подменяет файл после проверки  | Storage | 2 |
|5 |  Storage подменяет файл после проверки  | Storage | 2 |
|6 |  Storage подменяет файл после проверки  | Storage | 1 |
|7 |  Storage подменяет файл после проверки  | Storage | 1 |
