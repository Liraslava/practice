...
#### Негативный сценарий 4. Data input отправляет данные в обратном направлении

![Негативный сценарий4](./diagrams/docs/report/sd-negative/negative4.png?raw=true "Data input отправляет данные обратно на устройство")

Результат: недостижение цели безопасности №2: нарушение однонаправленного обмена данными

#### Негативный сценарий 5. Output подключается к device

![Негативный сценарий5](./diagrams/docs/report/sd-negative/negative5.png?raw=true "Data output имеет возможность отправить данные на устройство")
...
#### Негативный сценарий 7. Output подключается к device Verifire не проверяет данные
