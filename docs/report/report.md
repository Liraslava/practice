...
- [Отчёт о выполнении задачи "КУМО"](#отчёт-о-выполнении-задачи-шлюз-данных)
  ...
  - [Принцип работы тестов политик безопасности\*](#принци-работы-тестов-политик-безопасности)
