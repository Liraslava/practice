...
![Негативный сценарий4](./diagrams/docs/report/sd-negative/negative4.png?raw=true "Data input тправляет данные обратно на устройство")
...
#### Негативный сценарий 7. Output подключается к device 
