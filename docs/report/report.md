...
#### Негативный сценарий 6. Verifire отправkztn ложный результат проверки 
...
Результат: нестижение цели безопасности №2: нарушена однонаправленность передачи данных
