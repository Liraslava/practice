...
- [Отчёт о выполнении задачи "КУМО"](#отчёт-о-выполнении-задачи-шлюз-данных)
  ...
  - [Переработанная архитектура решения "Шлюз данных"](#переработанная-архитектура-решения-шлюз-данных)
    ...
    - [Описание cценариев (последовательности выполнения операций), при которых ЦБ нарушаются\*](#описание-cценариев-последовательности-выполнения-операций-при-которых-цб-нарушаются)
      ...
      - [Негативный сценарий 4. Output подключается к device ](#негативный-сценарий-4-data-output-имеет-возможность-отправить-данные-на-устройство)
      - [Негативный сценарий 5. Data input отправляет данные в обратном направлениии](#негативный-сценарий-5-storage-подменяет-файл-после-проверки)
      - [Негативный сценарий 6. Verifire отправляет ложный результат проверки](#негативный-сценарий-6-storage-подменяет-файл-после-проверки)
      - [Негативный сценарий 7. Manager не проверяет печать, установленную Verifire](#негативный-сценарий-7-storage-подменяет-файл-после-проверки)
  ...
  - [Запуск юнит-тестов\*](#запуск-приложения-и-тестов)
...
|----|----|Verifier|Повышающий доверие|Нарушается ЦБ 1|
|----|----|Updater|Повышающий доверие|Нарушается ЦБ 1|
